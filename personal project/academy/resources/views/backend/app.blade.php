...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed {{ request()->routeIs('application.view') || request()->routeIs('application.all') ? ' active' : '' }}" 
       ...
       href="#">
        <i class="bi bi-bar-chart"></i><span>Manage Applications</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#charts-nav2" data-bs-toggle="collapse" href="#">
      <i class="bi bi-bar-chart"></i><span>Manage Counsellors</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-bar-chart"></i><span>Settings</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="charts-apexcharts.html">
          <i class="bi bi-circle"></i><span>Manage Managers</span>
        </a>
      </li>
      <li>
