            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="{{route('admin.application.update', $app->id)}}" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"  name="full_name" placeholder="Full Name" value="{{$app->full_name}}" class="form-control" id="inputName5">
                ...
                <div class="col-md-6">
                  ...
                  <input type="email" name="email" placeholder="Email" value="{{$app->email}}" class="form-control" id="inputEmail5">
                  <p style="font-weight:bold; color:red; font-size:12px;">
                  @error('email')
                    {{$message}}
                  @enderror
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="mobile" value="{{$app->mobile}}"  placeholder="Mobile" class="form-control" id="inputPassword5">
                  <p style="font-weight:bold; color:red; font-size:12px;">
                  @error('mobile')
                    {{$message}}
                  @enderror
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" value="{{$app->extra_curriculum}}" name="extra_curriculum" class="form-control" id="inputCity" placeholder="Extra curriculars">
                  <p style="font-weight:bold; color:red; font-size:12px;">
                  @error('recommendation')
                    {{$message}}
                  @enderror
