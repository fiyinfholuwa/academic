...
@section('content')
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="padding-top:20px;">Hello Chris Cains,</h1>
                ...
                <div style="min-height:150px" class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div style="padding:50px;" class="ps-3">
                      <h6 style="color:#1a77e5; font-size:100px;">24</h6>
              ...
              <div class="card info-card sales-card">
                ...
                <div style="min-height:150px" class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div style="padding:50px;" class="ps-3">
                    <h6 style="color:#1a77e5; font-size:100px;">7</h6>
              ...
              <div class="card info-card sales-card">
                ...
                <div style="min-height:150px" class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div style="padding:50px;" class="ps-3">
                    <h6 style="color:#1a77e5; font-size:100px;">5</h6>
